...
ResultSet lRes;
    ...
    public ConectaGeral() {
        super (" SISTEMA INTEGRADO DE CONTROLE ");
...
//       setUndecorated(true);
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/BIBLIA.png"))); // NOI18N
        ...
        usuarioBanco.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
...
private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
    ...
    String verifica="0";
    String Usuario = null,Senha = null,Funcao = null;
    sSql="SELECT * FROM USUARIO WHERE USUARIO = '"+usuarioBanco.getText()+"' AND SENHA='"+SenhaBanco.getText()+"';";
    con.conecta();
    ...
    try 
    {
        while (lRes.next())
        {
             verifica= lRes.getString("IDUSUARIO");
    ...
    {
        Parametros.setsNmUsuas(Usuario.trim());
        Parametros.setsSenhaUsuas(Senha.trim());
        Parametros.setsFuncao(Funcao.trim());
